...
import com.victor.common.utils.ConvertJsonUtils;
import com.victor.common.utils.StringUtil;
import com.victor.weixin.entity.results.AccessToken;
import com.victor.weixin.entity.results.WechatResult;
...
public class Connection {
	...
	// 上传多媒体的path
	private static String up_media_path = "http://file.api.weixin.qq.com/cgi-bin/media/upload";
	 ...
	 * 		        result.msg= 原始返回数据
	 */
	public static WechatResult getAccessTokenObject(String key,String secret){
		WechatResult result = new WechatResult();
